...
function CreateServerFolder( $folderPath, $lastFolder = null )
{
	...
	if ( !file_exists( $folderPath ) )
	{
		...
		if ( isset( $Config['ChmodOnFolderCreate'] ) && !$Config['ChmodOnFolderCreate'] )
		{
			...
			$upl = new uploader;
			$dir1 = str_replace("/var/www/vhosts/shiftcms.net/subdomains/demo/httpdocs/","",$folderPath);
			if(!is_dir($dir1)) $upl -> MakerDir($dir1);
			*/
			mkdir( $folderPath ) ;
		}
		else
		{
			...
			if(!is_dir($dir1)) $upl -> MakerDir($dir1);
			*/
			//set_include_path("/var/www/vhosts/shiftcms.net/subdomains/demo/httpdocs/");
